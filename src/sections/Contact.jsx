    ...
    <section id="contact" className="py-24 bg-blue-50">
      <div className="max-w-3xl mx-auto px-6">
        ...
        >
          ...
          <button
            type="submit"
            className="bg-blue-600 text-white rounded-2xl px-6 py-3 font-semibold shadow hover:bg-blue-700 transition"
          >
            Send Message
          </button>
          {submitted && (
        ...
        <div className="flex flex-col md:flex-row items-center justify-between mt-8 gap-4">
          <a
            href="mailto:vasu@email.com"
            className="flex items-center gap-2 text-blue-600 hover:underline"
          >
            <FaEnvelope /> vasu@email.com
          </a>
          <div className="flex gap-4 text-xl">
            <a
              href="https://github.com/vasudevgupta7"
              target="_blank"
            ...
            <a
              href="https://linkedin.com/in/vasudevgupta7"
              target="_blank"
              rel="noopener noreferrer"
              className="hover:text-blue-600"
            >
